...
public struct Emitter {
    ...
    public init(particleCount: Int, size: CGSize, life: Float, device: MTLDevice) {
        ...
        let color = float3(Float.random(in: 0...life) / life, Float.random(in: 0...life) / life, Float.random(in: 0...life) / life)
